from .quiz_views import QuizSearchList , QuizFeedBack , LessonPathView ,LocationPathView ,SourceView , QuizCreate , QuizUpdate
...
from restAPI.views.qa import (LastQuestionsView,QuestionAnsListView , QuestionListView ,
            QuestionDetailView ,  QAHandler , CreateQuestionView , CreateAnswerView)